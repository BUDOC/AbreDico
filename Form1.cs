...
namespace AbreDico
{
    public partial class Form1 : Form
    {
            ...
            { // le mot proposé par joueur existe
                ...
                for (int i = 0; i < form1.findedWordList.Count; i++)
                {
                    if (form1.findedWordList[i] == form1.textBox1.Text)
                    {
                        ...
                        form1.labNotification.Font = new Font("Arial", 20);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < 4; j++)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    l.MouseHover += new EventHandler(this.LetterIsChoosen);
        ...
        private void PossibleWordsInTextbox2()
        {
            ...
            this.progressBar1.Maximum = int.Parse(this.ScoreMaxi().ToString());
        }
        ...
        private class LabelXY : Label
        {
            ...
            {
                System.Windows.Forms.ToolTip a = new System.Windows.Forms.ToolTip();
                a.InitialDelay = 1000;
                a.InitialDelay = 1000;
                a.ToolTipTitle = text;
                a.SetToolTip(this.Parent, "Pour annuler");
            }
        }
        ...
        private void LetterIsChoosen(object sender, EventArgs e)
        {
            ...
            {
                choisi.SetToolTipText("Touche Echap");
        ...
        private void Bt_test_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.bt_see_words.Text = "Cacher les mots";
            }
        }
        ...
        /// <summary>
        /// Détecte si la touche d'écahappement est appuyée.
